"""
=======================================================================
PROJECT: Lung Cancer Multi-class Classification (EfficientNetB0 + Grad-CAM)
DESCRIPTION:
...
output_dir = "/data/vaishnav25/ADITHYA/Results5"
...
# SAVE MODEL
# ============================================================
model.save(os.path.join(output_dir,"effnetb0_final.keras"))
