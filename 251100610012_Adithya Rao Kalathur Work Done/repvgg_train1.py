...
output_dir = "/data/vaishnav25/ADITHYA/Results1_RepVGG"
...
# 4️ LOAD RepVGG-A1
# ============================================================
# Using timm-converted weights (TF port)
repvgg_url = "https://github.com/berniwal/repvgg-tf/releases/download/v1.0/repvgg_a1_imagenet.h5"
weights_path = get_file("repvgg_a1_imagenet.h5", repvgg_url)

from tensorflow.keras import layers, models

def RepVGG_A1(input_shape=(224,224,3), num_classes=3):
    from tensorflow.keras.applications import ResNet50  # Fallback if you can’t import timm RepVGG
    base = tf.keras.applications.ResNet50(
        include_top=False, weights='imagenet', input_shape=input_shape)
    # mimic RepVGG-style head
    x = GlobalAveragePooling2D()(base.output)
    x = Dropout(0.3)(x)
    out = Dense(num_classes, activation='softmax', kernel_regularizer=l2(1e-4))(x)
...
# ============================================================
# 9️ GRAD-CAM (3 IMAGES PER CLASS)
# ============================================================
...
# 10 SAVE MODEL
# ============================================================
model.save(os.path.join(output_dir,"repvgg_a1_final.keras"))
